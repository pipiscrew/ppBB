...
class dbase{
	...
	function connect_sqlite() {
		...
		if ($d==0)
		{
			$this->executeSQL('CREATE TABLE "categories" ( "cat_id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "cat_name" TEXT NOT NULL, "cat_last_update" TEXT, "cat_private" INTEGER, "cat_order" INTEGER )', null);
