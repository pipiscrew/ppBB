...
//                PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,      WARNING - when ON cant create the dbase
		...
		if ($d==0)
		{
			$this->executeSQL('CREATE TABLE "categories" ( "cat_id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "cat_parent_id" INTEGER DEFAULT 0, "cat_name" TEXT NOT NULL, "cat_last_update" TEXT, "cat_private" INTEGER, "cat_order" INTEGER DEFAULT 0 )', null);
